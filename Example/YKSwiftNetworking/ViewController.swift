...
extension ViewController {
    ...
    func testNormalRequest() {
        ...
        var normalnetwork = YKSwiftNetworking.init().method(.GET).url("https://www.baidu.com")
...
//        }, onDisposed: nil).disposed(by: self.disposeBag)
        ...
        // 最后成熟的请求方式
        self.networking.get("https://www.baidu.com").params(["paramsKey":"paramsValue"]).header(["headerKey":"headerValue"]).mockData("ceshiBase".data(using: .utf8)).progress({ progress in
